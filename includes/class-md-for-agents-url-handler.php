...
/**
 * Handles markdown-format front-end requests.
 */
class MD_For_Agents_URL_Handler {
	...
	/**
	 * Register the markdown request handler.
	 *
	 * @param MD_For_Agents_Markdown_Converter $converter Markdown converter instance.
	 */
